  ...
  programs.yazi = {
    ...
    theme = with config.lib.stylix.colors; {
      manager = {
        ...
        hovered = { fg = "#${base00}"; bg = "#${base0C}"; bold = true; };
        preview_hovered = { fg = "#${base0D}"; bg = "reset"; };

        find_keyword = { fg = "#${base0F}"; italic = true; underline = true; };
